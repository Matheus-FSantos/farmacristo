...
public record ProductDTO(UUID id, String name, String description, String brand, @JsonIgnore Double price, @JsonIgnore Double promotionalPrice, Boolean prescriptionIsRequired, List<PharmacyDTO> pharmacies) {
